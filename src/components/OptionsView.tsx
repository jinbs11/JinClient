    ...
    <div className="w-full h-full select-none">
      ...
      <div className="w-full h-full bg-[#242635] rounded">
        <div className="flex flex-col gap-5 items-center justify-center">
          <div className="flex bg-[#15161F] bg-opacity-50 justify-center items-center w-full max-w-screen-md mx-auto m-4 h-36 rounded">
            <button
              className="bg-green-700 text-xl rounded-md px-20 py-4 hover:bg-green-800"
